...
function carbon_print_layout($layout) {//view fields
	?>
	<div class="section <?= $layout['full_width_section'] ? 'container-fluid' : 'container'; ?> <?= $layout['content_contained'] ? 'content-contained' : null; ?>  <?= $layout['mobile_center_text'] ? 'mobile-center-text' : null; ?> <?= $layout['section_class']; ?>" style="<?=cfpb_bg_image($layout['section_background_image'])?>">
